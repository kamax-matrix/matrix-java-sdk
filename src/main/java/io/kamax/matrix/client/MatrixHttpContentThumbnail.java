...
public class MatrixHttpContentThumbnail extends AMatrixHttpClient implements _MatrixContent {
    ...
    public MatrixHttpContentThumbnail(MatrixClientContext context, URI address, long width, long height) {
        super(context);
    ...
    private synchronized void load() {
        ...
        try {
            if (!StringUtils.equalsIgnoreCase("mxc", address.getScheme())) {
                ...
                URI path = getMediaPathBuilder("/thumbnail/" + address.getHost() + address.getPath())
                        .addParameter("width", Long.toString(width))
                        .addParameter("height", Long.toString(height))
                        .addParameter("method", "crop")
                        .build();
            ...
            log.error("Unable to create URI for thumbnail request");
